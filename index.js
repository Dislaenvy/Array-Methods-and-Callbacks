...
const allFinals = fifaData.filter(function(item){
    return item.Year === 2014 || item.Stage === 'Final';

    });
    
console.log(allFinals[0]['Home Team Name'])
//(b) Away Team name for 2014 world cup final
console.log(allFinals[0]['Away Team Name'])
//(c) Home Team goals for 2014 world cup final
console.log(allFinals[0]['Home Team Goals'])
//(d) Away Team goals for 2014 world cup final
console.log(allFinals[0]['Home Team Goals'])
//(e) Winner of 2014 world cup final */
console.log(allFinals[0]['Win conditions'])
// 
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 2: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
...
function getYears(array, callback) {
    const newArray = callback(array).map(function(item){
        return item.Year;
    });
...
function getWinnersByYear(array, getYearscb, getWinnerscb) {
    const dataYear = getYearscb(array, getFinals);
    const country = getWinnerscb(array, getFinals);
    const data = dataYear.map((year, index) => {
